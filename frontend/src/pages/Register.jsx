        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            ...
            <form  className="d-flex flex-column border border-dark shadow rounded p-5 justify-content-between align-items-center" action="">
                ...
                <label className="mt-3" htmlFor="username"><h2>Username</h2></label>           
                <input className="form-input text-center" type="text" id="username" name="username" placeholder="johnsmith123"/>

                <label className="mt-3" htmlFor="password"><h2>Password</h2></label>           
                <input className="form-input text-center" type="password" id="password" name="password" />  
                
                <label className="mt-3" htmlFor="password2"><h2>Confirm Password</h2></label>           
                <input className="form-input text-center" type="password" id="password2" name="password2" />  

                <button className="form-button d-flex justify-content-center align-items-center mt-5 w-100 " type="submit">
                        Register                        
                </button>
                <p>Have an account? <br/>Login <Link to="/login"><span className="title-red">here</span></Link></p>
            </form>        
            </div>
          </div>
        </div>
